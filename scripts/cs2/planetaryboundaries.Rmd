...
RoSa: We have better output and results for this, so this should be preliminary.
-->
```{r}
...
showLinePlotsWithZones(
  ...
  # this is taken from Beier et al (2025), Richardson et al (2023) state 62, and upper limit 82
  safePB = 61,
  highRisk = 84
)
```
