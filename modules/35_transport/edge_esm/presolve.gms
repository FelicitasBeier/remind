...
*** Track runtime
    putclose runtime system.date system.Time "iterativeEdgeTransport" "start" iteration.val;

    Execute "Rscript -e 'edgeTransport::iterativeEdgeTransport()'";

*** Track runtime
    putclose runtime system.date system.Time "iterativeEdgeTransport" "end" iteration.val;
